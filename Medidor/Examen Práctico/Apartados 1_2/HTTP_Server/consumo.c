...
void ADC1_pins_F429ZI_config_consumo(void)
{
  ...
  /* Configuración PIN ADC // El PIN del ADC va a ser el A3 == PF5 en CN9 */
...
/**
  ...
  */
int ADC_Init_Single_Conversion_consumo(ADC_HandleTypeDef *hadc, ADC_TypeDef  *ADC_Instance)
{
...
/**
  ...
  */
float ADC_getVoltage_consumo(ADC_HandleTypeDef *hadc, uint32_t Channel)
{
