...
typedef struct {
    ...
    float corriente;
		...
		/*---------------- VARIABLES ----------------*/
//		extern osTimerId_t tim_ThEscritura; //Timer para esperar que la escritura se ha realizado correctamente
//		extern osThreadId_t tid_ThMemoria; //Id del hilo que gestiona la memoria
